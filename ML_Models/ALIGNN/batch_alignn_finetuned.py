...
# Создать архитектуру модели (пустую)
...
# Загрузить дообученные веса
checkpoint = torch.load(
    "finetune_checkpoints/best_model.pt",
    map_location="cpu",
    weights_only=False
)
...
df.to_csv("alignn_qmof_predictions_finetuned.csv", index=False)
...
print(f"\nСохранено: alignn_qmof_predictions_finetuned.csv")
